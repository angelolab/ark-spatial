...
Now that your new project repository has been created on github at `https://github.com/srivarra/ark` you can push your first commit to github.
...
git remote add origin https://github.com/srivarra/ark.git
...
Your project should be now available at `https://github.com/srivarra/ark`. While the repository at this point can be directly used, there are few remaining steps that needs to be done in order to achieve full functionality.
...
The workflows should now succeed and you will be able to find the code coverage at this link: `https://app.codecov.io/gh/srivarra/ark`. You might have to wait couple of minutes and the coverage of this repository should be ~60%.
